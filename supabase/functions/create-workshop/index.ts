...
serve(async (req: Request) => {
  ...
  try {
    ...
    // b. Calculate and create sessions
    ...
    // d. Create participants and their session records
    ...
    return new Response(JSON.stringify({ message: 'Workshop created successfully.' }), {
      headers: { ...corsHeaders, 'Content-Type': 'application/json' },
      status: 200,
    });
